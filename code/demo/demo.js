...
$(document).ready(function() {
    ...
    if (myDocker) {
        ...
        // --------------------------------------------------------------------------------
        // Register the Viewer List, a demonstration of the layout batch system when
        // adding an overwhelming number of elements into the layout all at once.
        myDocker.registerPanelType('Viewer List', {
            faicon: 'cubes',
            onCreate: function(myPanel) {

                myPanel.initSize(3000, 500);
                myPanel.layout().scene().css('padding', '10px');
        ...
        myDocker.registerPanelType('Viewer Panel', {
            isPersistent: true,
        ...
        var tutorialPanel = myDocker.addPanel('Viewer Panel', wcDocker.DOCK.LEFT);
        ...
        // var batchPanel = myDocker.addPanel('Viewer List', wcDocker.DOCK.STACKED, controlPanel, {
        //     tabOrientation: wcDocker.TAB.BOTTOM
        // });


        var batchPanel = myDocker.addPanel('Viewer List', wcDocker.DOCK.RIGHT);
